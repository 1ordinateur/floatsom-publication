...
python3 -m floatsom_benchmarks.speed_benchmarks.run_gpu_scaling_benchmark \
  ...
  --output_dir "/g/data/eu59/SIFEAN/sfa/2gpu_scaling_random_21032026/results" \
  --temp_dir "/scratch/eu59/SIFEAN/sfa/2gpu_scaling_random/temp" \
