...
RNG_RANDOM_PARAMS_JSON="${RNG_RANDOM_PARAMS_JSON:-floatsom_min1000_tuned_defaults_rng_random.json}"
RNG_MST_CONFIG_PARAMS_JSON="${RNG_MST_CONFIG_PARAMS_JSON:-floatsom_min1000_tuned_defaults_rng_mst_config.json}"
