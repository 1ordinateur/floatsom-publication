...
\noindent\emph{Algorithm 1. Dynamic MST topology update with refresh-triggered recomputation and cached influence reuse.}
...
\noindent\emph{Algorithm 2. Dynamic RNG topology update with refresh-triggered recomputation and cached influence reuse.}
...
Rows list per-dataset and \texttt{GLOBAL\_OVERALL} entries with the plotted median percent change and 95\% confidence interval. See \texttt{assets/tables/supp\_table\_figure\_13\_xpysom\_rng\_deployment\_summary.tsv}.
