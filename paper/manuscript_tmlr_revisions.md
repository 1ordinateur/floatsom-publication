...
Among the graph topologies, RNG gave the most favourable $QE$, stability, and node-utilization results, making it a reasonable default, with some improvement over a tuned hexagonal lattice. At larger node numbers, we suggest instead the MST topology.
