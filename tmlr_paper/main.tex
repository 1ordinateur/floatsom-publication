...
\author{\name Tony Xu \email tony.xu@anu.edu.au \\
        ...
        \addr John Curtin School of Medical Research, Australian National University
        \AND
        \name Felix Marsh-Wakefield\thanks{Felix Marsh-Wakefield and Givanna Putri contributed equally as co-last authors.} \\
        \addr Centenary Institute of Cancer Medicine and Cell Biology\\
        University of Sydney
        \AND
        \name Givanna Putri\footnotemark[1] \\
        \addr Walter and Eliza Hall Institute}

\hypersetup{
  pdftitle={FloatSOM: GPU Accelerated, Distributed, Topology-Flexible Self-Organizing Maps},
  pdfauthor={Tony Xu; Sarah Klamt; Katherine Turner; Anne Brüstle; Felix Marsh-Wakefield; Givanna Putri}
}
