...
% TODO(TMLR CAMERA-READY): Confirm publication month/year and OpenReview forum URL.
% These publisher-specific fields are pending author input; do not infer them.
\def\month{MM}
\def\year{YYYY}
...
The FloatSOM source code is available at \url{https://github.com/1ordinateur/floatsom}. The manuscript sources, figure assets, benchmark code, and supporting analysis tables are available at \url{https://github.com/1ordinateur/floatsom-publication}.
